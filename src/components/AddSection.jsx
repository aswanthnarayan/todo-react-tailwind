  ...
  return (
    <div className="w-full lg:w-7/12 mt-0 flex flex-col md:flex-row lg:flex-col gap-0  md:justify-around lg:justify-start xl:justify-center">
      <div className='h-64  hidden md:flex justify-center' >
        <img className='object-cover h-full md:h-44 lg:h-full' src={todoo} alt="" />
      </div>
      <form className='flex flex-col gap-2' onSubmit={handleSubmit}>
      <h2 className='text-l md:text-lg lg:text-2xl font-bold uppercase'>Add Your Task</h2>
        <input
          type="text"
        ...
        <button type="submit" className=" bg-[#7AB2B2] w-full lg:w-40 py-2 lg:py-4 rounded-md uppercase text-white font-bold">Add
        </button>
      </form>
    </div>
  )
